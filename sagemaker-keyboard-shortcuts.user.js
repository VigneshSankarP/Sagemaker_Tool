...
(function() {
    ...
    console.log('⌨️ SageMaker Keyboard Shortcuts v1.0');
    ...
    function cloneExactStructure() {
        ...
        if (!crowdClassifier) return false;
        ...
        if (!defaultNumberElement) return false;
        ...
        for (const shortcut of SHORTCUTS) {
            ...
            for (const el of allElements) {
                if (el.querySelector(`.exact-clone-${shortcut.key}`)) continue;
